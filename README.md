...
![willie-worker architecture](./assets/logo.png)
...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/WillieOSS/willie-worker)
...
- [Kimi Code API key](https://kimi.com/code), or you can use AI Gateway's [Unified Billing](https://developers.cloudflare.com/ai-gateway/features/unified-billing/)
...
![willie-worker architecture](./assets/architecture.png)
...
# Set your API key (direct Kimi Code access)
...
The `AI_GATEWAY_*` variables take precedence over `KIMI_*` if both are set.
...
| `KIMI_API_KEY` | Yes* | Direct Kimi Code API key (fallback if AI Gateway not configured) |
